...
using RoverController.Web.API.Providers;
using RoverController.Web.API.Results;
    ...
    public class AccountController : BaseApiController
    {
        ...
        public IHttpActionResult GetUserInfo()
        {
            try
            {
                ...
                var userDTO = AppService.Users.Get(identity.GetUserId());
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            return Ok(AppService.CurrentUser);
        }
